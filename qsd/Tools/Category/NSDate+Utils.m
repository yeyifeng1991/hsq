...
+ (NSString *) dayStringWithSince1970Date:(NSTimeInterval)timeInterval {
...
+ (NSString *) stringWithSince1970Date:(NSTimeInterval)timeInterval {
    NSDateFormatter *format = [[NSDateFormatter alloc] init];
    [format setTimeZone:[NSTimeZone timeZoneWithAbbreviation:@"UTC"]];
    NSTimeZone *timezone = [[NSTimeZone alloc] initWithName:@"Asia/Shanghai"];
    [format setTimeZone:timezone];
...
+ (NSString *) stringWithSince1970DateNOss:(NSTimeInterval)timeInterval {
    NSDateFormatter *format = [[NSDateFormatter alloc] init];
    [format setTimeZone:[NSTimeZone timeZoneWithAbbreviation:@"UTC"]];
    NSTimeZone *timezone = [[NSTimeZone alloc] initWithName:@"Asia/Shanghai"];
    [format setTimeZone:timezone];
...
+ (NSString *)stringYearMonthDayWithDate1:(NSDate *)date1;
...
+ (NSDate *) dateStandardFormatTimeZeroWithDate: (NSDate *) aDate{
    NSString *str = [[NSDate stringYearMonthDayWithDate1:aDate]stringByAppendingString:@" 00:00:00"];
