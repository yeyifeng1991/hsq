...
+ (NSString *)stringYearMonthDayWithDate1:(NSDate *)date1;     //date为返回2009-12-09类型
+ (NSString *)dateMonthDayWithDate:(NSDate *)date;
+ (NSString *)stringLoacalDate;
+ (NSString *) stringWithSince1970Date:(NSTimeInterval)timeInterval; //格式为YY:MM:DD HH:MM:SS
+ (NSString *) dayStringWithSince1970Date:(NSTimeInterval)timeInterval ; //格式为YY:MM:DD
+ (NSString *) stringWithSince1970DateNOss:(NSTimeInterval)timeInterval; //格式为YY:MM:DD HH:MM
